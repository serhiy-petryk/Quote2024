...
namespace Data.Scanners
{
    public class HourPolygon
    {
        ...
        public static void xxStartHourHalf()
        {
            ...
            Start("dbQ2024Tests2..HourHalfPolygon", timeCommon, timeShortened);
        }
        ...
        public static void StartHour()
        {
            ...
            Start("dbQ2024Tests2..HourPolygon2", timeCommon, timeShortened);
        }
