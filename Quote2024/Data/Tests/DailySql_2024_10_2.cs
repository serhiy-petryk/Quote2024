...
{
    public static class DailySql_2024_10_2
    {
        public static void Start()
        {
            var opens = new string[]
                { "O0930", "O0935", "O0940", "O0945", "O0950", "O0955", "O1000", "O1005", "O1010", "O1015", "O1020", "O1025"};
            var closes = new string[]
            {
                "O0930", "O0935", "O0940", "O0945", "O0950", "O0955", "O1000", "O1005", "O1010", "O1015", "O1020",
                "O1025", "O1520", "O1525", "O1530", "O1535", "O1540", "O1545", "O1550", "O1555"
            };

            var sqlTemplate = ";with data as\n" +
                              "(\n" +
                              "select (a.[Open]-a.[Close])/a.[Open]*100 PrevOpenRate,\n" +
                              "(a.[Open]-a.[Close])/(a.[Open]+a.[Close])*200 PrevCOn" +
