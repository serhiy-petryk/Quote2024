...
{
    public partial class PolygonMarketSnapshotForm : Form
    {
        ...
        public PolygonMarketSnapshotForm()
        {
            InitializeComponent();
        ...
        private async void btnStart_Click(object sender, EventArgs e)
        {
            ...
            Debug.Print($"PolygonMarketSnapshotForm started: {DateTime.Now.TimeOfDay}");
