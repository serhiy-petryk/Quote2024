...
namespace Quote2024.Forms
{
    public partial class MainForm : Form
    {
        ...
        private async void btnTest_Click(object sender, EventArgs e)
        {
            ...
            // Data.Actions.Investing.InvestingSplitsLoader.ParseZipAndSaveToDb(@"E:\Quote\WebData\Splits\Investing\InvestingSplits_20260509.zip");
        ...
        private void btnPolygonSnapshots_Click(object sender, EventArgs e)
        {
            var form = new PolygonSnapshotsForm();
            form.Show();
        }
    }
}
